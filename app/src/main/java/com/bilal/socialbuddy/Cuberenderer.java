...
//		// Position the eye behind the origin.
		...
		if (mProgramHandle != 0) 
		{
			...
			GLES20.glLinkProgram(mProgramHandle);
			 mTextureDataHandle0 = loadTexture(mActivityContext, R.drawable.bricks);
			 mTextureDataHandle1 = loadTexture(mActivityContext, R.drawable.bricks);
			 mTextureDataHandle2 = loadTexture(mActivityContext, R.drawable.bricks);
			 mTextureDataHandle3 = loadTexture(mActivityContext, R.drawable.bricks);
			 mTextureDataHandle4 = loadTexture(mActivityContext, R.drawable.bricks);
			 mTextureDataHandle5 = loadTexture(mActivityContext, R.drawable.door);
